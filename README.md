...
<h1 style="color:#fff; margin-top:290px; font-family: 'Azeret Mono', monospace; font-family: 'Ubuntu', sans-serif; font-size:50px;  background-image: linear-gradient(to left, #FFFFF0 90px, #E0FFFF , #FFFFE0);
